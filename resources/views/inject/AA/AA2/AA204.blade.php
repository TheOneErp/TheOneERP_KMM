...
<script>
    ...
    window.injects.injectOnEdit.push((that, pageData, id) => {
        that.dataset.override.fields['combi_code']  = { field_readonly : true };
        that.dataset.override.fields['product_code']  = { field_readonly : true };
        let subData = that.dataset.subData[bodyId1];
        for(let element of subData){
            element.override.preventDelete = true;
            element.override.fields['cont_code'] = { field_readonly : true }
            element.override.fields['body_num'] = { field_readonly : true }
            element.override.fields['body_rate'] = { field_readonly : true }
            element.override.fields['unit_name'] = { field_readonly : true }
        }
